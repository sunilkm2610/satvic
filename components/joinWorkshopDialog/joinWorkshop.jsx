...
import FeatueCard from "../workshop/featueCard";
...
const JoinWorkshop = ({ open, handleOpen, step, setStep }) => {
  return (
    <Dialog open={open} className="rounded-[24px]" onOpenChange={handleOpen}>
